; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27026.1 
	...
	TITLE	C:\Users\Xc170\OneDrive\Documentos\Roberto\Compilador\Compilador\Compilador.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__292DFBBC_compilador@cpp DB 01H
...
PUBLIC	??_C@_0N@CPAIKIKG@Hola?5Mundo?$CB?$CB@		; `string'
EXTRN	_strlen:PROC
...
rtc$IMZ	ENDS
;	COMDAT ??_C@_0N@CPAIKIKG@Hola?5Mundo?$CB?$CB@
CONST	SEGMENT
??_C@_0N@CPAIKIKG@Hola?5Mundo?$CB?$CB@ DB 'Hola Mundo!!', 00H ; `string'
CONST	ENDS
;	COMDAT xdata$x
xdata$x	SEGMENT
...
_TEXT	SEGMENT
_main	PROC						; COMDAT
; File c:\users\xc170\onedrive\documentos\roberto\compilador\compilador\compilador.cpp
; Line 5
	push	ebp
	mov	ebp, esp
	sub	esp, 192				; 000000c0H
	...
	mov	eax, -858993460				; ccccccccH
	rep stosd
	mov	ecx, OFFSET __292DFBBC_compilador@cpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 6
	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0N@CPAIKIKG@Hola?5Mundo?$CB?$CB@
